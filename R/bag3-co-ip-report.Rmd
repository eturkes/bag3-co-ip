...
df_abun_ratio <- data.table::data.table(
    "QRILC" = dt_qrilc[[cols[2]]],
    "HM" = dt_hm[[cols[2]]],
    "10% Min" = dt_10min[[cols[2]]],
    "Within Condition Min" = dt_cond_min[[cols[2]]]
)
...
plotly::ggplotly(ggplot2::ggplot(df_abun_ratio, ggplot2::aes(x = value, fill = variable)) +
    ...
    ggplot2::xlab("Abundance Ratio: log2(scr/sh)")
)

# plotly::ggplotly(ggplot2::ggplot(dt_10min, ggplot2::aes(`Abundance Ratio: log2(scr/sh)`)) +
#     ggplot2::geom_histogram(bins = 100, fill = "gray", color = "black")
# )

plotly::ggplotly(ggplot2::ggplot(df_abun_ratio, ggplot2::aes(x = value, fill = variable)) +
    ggplot2::geom_histogram(alpha = 0.25, bins = 10) +
    ggplot2::xlab("Abundance Ratio: log2(scr/sh)")
)
```
