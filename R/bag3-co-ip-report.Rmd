...
eturkesRutils::datatable(dt_10min) %>% DT::formatStyle("Genes", `text-align` = "center")
```
...
eturkesRutils::datatable(dt_cond_min) %>% DT::formatStyle("Genes", `text-align` = "center")
```
