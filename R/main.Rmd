...
The above table does not appear to be sorted in any obvious way. So, we explore sorting schemes most relevant to this dataset. The schemes can be cycled through the tabs below.
