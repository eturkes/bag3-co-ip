...
![](../assets/debug/mydata-top-to-bottom-debug.png "Top to bottom debug flow leading to error")

#### Our data (left) compared to example data (right) at point of error
![](../assets/debug/left-mydata-right-untargeted.png "Our data (left) compared to example data (right) at point of error")
...
#### WDD: Direct to BAG3
![](../assets/watson/network-bag3-co-ip-direct-to-bag3.png "WDD: Direct to BAG3")
...
#### WDD: Including Indirect to BAG3
![](../assets/watson/network-bag3-co-ip-indirect-to-bag3.png "WDD: Including Indirect to BAG3")
