...
```{r, include = TRUE, echo = FALSE}
cols <- c(
  "Genes", "Abundance Ratio: (scr/sh)", "Watson Confidence", "scrRNA Abundance", "shBAG3 Abundance"
)
co_ip_genes <- co_ip_genes[order(-co_ip_genes[[cols[3]]], -co_ip_genes[[cols[2]]]), ]
...
```{r, include = TRUE, echo = FALSE}
co_ip_genes <- co_ip_genes[order(-co_ip_genes[[cols[4]]], -co_ip_genes[[cols[5]]]), ]
