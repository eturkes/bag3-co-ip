...
We start by loading in any required packages for our analysis.
...
```{r}
co_ip_genes <- data.table(read_excel(
...
```{r}
watson_direct_graph <- fread("../assets/watson/relationshipgraph-bag3-co-ip-direct-to-bag3.csv")
watson_indirect_graph <- fread("../assets/watson/relationshipgraph-bag3-co-ip-indirect-to-bag3.csv")
