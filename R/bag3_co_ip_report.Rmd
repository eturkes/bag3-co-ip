...
Watson for Drug Discovery (WDD) is a text-mining platform that has built a massive corpus of scientific insights drawn from publications and other data forms.
